...
export const metadata: Metadata = {
  ...
  description: 'This page has moved to /guide/importing/.',
...
export default function WebImportRedirect() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-blue-900">
      <meta httpEquiv="refresh" content="0;url=/guide/importing/" />
      <div className="text-center px-4">
        <p className="text-gray-600 dark:text-gray-300 mb-2">This page has moved.</p>
        <Link href="/guide/importing/" className="text-blue-600 dark:text-blue-400 hover:underline font-semibold">
          Continue to Importing Games &rarr;
        </Link>
      </div>
    </div>
  );
