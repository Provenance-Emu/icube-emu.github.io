...
export const metadata: Metadata = {
  title: 'Import Games over Wi-Fi',
  description:
    'How to import GameCube and Wii games into iCube over Wi-Fi using the built-in web server. Drag and drop ROM/ISO files from your computer, or use the WebDAV URL in Finder.',
  alternates: { canonical: 'https://icube-emu.com/help/web-import/' },
};

export default function WebImportHelp() {
  return (
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Use supported formats &mdash; GameCube ISO, and Wii WBFS or ISO. Very
                    large transfers can take a while, so let the upload finish before closing
                    the page.
                  </p>
                </div>
              </div>
