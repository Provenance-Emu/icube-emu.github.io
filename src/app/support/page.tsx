          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 mb-8">
            ...
            <div className="space-y-6">
              ...
              <div className="border-b border-gray-200 dark:border-gray-700 pb-4">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  iCube requires iOS 15.0 or later for iPhone and iPad, and tvOS 15.0 or later for Apple TV. 
                  For optimal performance, we recommend newer devices like iPhone 12 or later, 
                  iPad (6th generation) or later, and Apple TV 4K.
                </p>
              </div>
              ...
              <div className="border-b border-gray-200 dark:border-gray-700 pb-4">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  ...
                  through regular updates. Check our compatibility list for game-specific information.
                </p>
              </div>
